...
class LanguageService {
  ...
  static Map<String, Map<String, String>> translations = {
    'English': {
      ...
      'profile': 'Profile',
      'identify_a_snake': 'Identify a Snake',
      'scan_subtitle': 'Tap here to scan and identify\na snake in real-time.',
      'quick_services': 'Quick Services',
      'view_past_identifications': 'View past identifications',
      'report_incident': 'Report an Incident',
      'report_snake_subtitle': 'Report a snake sighting or incident',
    ...
    'தமிழ்': {
      ...
      'collection': 'தொகுப்பு',
      'profile': 'சுயவிவரம்',
      'identify_a_snake': 'பாம்பை அடையாளம் காணுங்கள்',
      'scan_subtitle': 'நிகழ்நேரத்தில் பாம்பை ஸ்கேன் செய்ய இங்கே தட்டுங்கள்.',
      'quick_services': 'விரைவு சேவைகள்',
      'view_past_identifications': 'கடந்த அடையாளங்களை காண்க',
      'report_incident': 'சம்பவத்தை புகாரளியுங்கள்',
      'report_snake_subtitle': 'பாம்பு தோற்றம் அல்லது சம்பவத்தை புகாரளியுங்கள்',
      'did_you_know': 'உங்களுக்குத் தெரியுமா?',
      'dismiss': 'நிராகரி',
      'experts': 'நிபுணர்கள்',
      'live_map': 'நேரடி வரைபடம்',
      'call_1990': '1990 அழைக்கவும்',
      'scan': 'ஸ்கேன்',
