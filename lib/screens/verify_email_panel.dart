      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Check Your Email", style: TextStyle(color: Color(0xFF00FF66), fontSize: 26, fontWeight: FontWeight.bold)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text("Proceed to Login", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
